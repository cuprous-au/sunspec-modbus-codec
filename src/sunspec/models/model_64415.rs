...
pub static POINTS: [ReadablePoint; 7] = [
    ...
    ReadablePoint {
        reference: PointReference::Model64415 { point: Point::LogEventModeEnable },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model64415 { point: Point::HttpMessageModeEnable },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model64415 { point: Point::Comm004Certificate },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model64415 { point: Point::SubscribedResourceUrl },
        size: 64,
        data_type: PointType::String,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model64415 { point: Point::SubscribtionEnable },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    },
...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::LogEventModeEnable => if let Some(value) = model.log_event_mode_enable() { serialisation::write_u16(value as u16, buffer); },
        Point::HttpMessageModeEnable => if let Some(value) = model.http_message_mode_enable() { serialisation::write_u16(value as u16, buffer); },
        Point::Comm004Certificate => if let Some(value) = model.comm_004_certificate() { serialisation::write_u16(value as u16, buffer); },
        Point::SubscribedResourceUrl => if let Some(value) = model.subscribed_resource_url() { serialisation::write_string(value, buffer, offset, limit); },
        Point::SubscribtionEnable => if let Some(value) = model.subscribtion_enable() { serialisation::write_u16(value as u16, buffer); },
    }
}
...
pub trait ModelAdapter {
    ...
    fn subscribed_resource_url(&self) -> Option<String<128>> {
        None
    }
    ...
    ///
    /// The URL of the resource to subscribe to
    fn set_subscribed_resource_url(&mut self, value: String<128>) {
    }
