...
use sunspec_modbus_lib_rs::sunspec::models::model_112::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model112CallbackAdapter`, valid for the
...
unsafe fn model_112_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model112CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_112_callback(
    adapter: *mut Model112CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_112,
