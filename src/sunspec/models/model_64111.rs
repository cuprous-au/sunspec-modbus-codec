...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        ...
        Point::BatteryVoltage => {
            serialisation::write_u16(model.battery_voltage(), buffer);
        },
        Point::ArrayVoltage => {
            serialisation::write_u16(model.array_voltage(), buffer);
        },
        Point::OutputCurrent => {
            serialisation::write_u16(model.output_current(), buffer);
        },
        Point::ArrayCurrent => {
            serialisation::write_u16(model.array_current(), buffer);
        },
        Point::OperatingState => {
            serialisation::write_u16(model.operating_state() as u16, buffer);
        },
        Point::OutputWattage => {
            serialisation::write_u16(model.output_wattage(), buffer);
        },
        ...
        Point::Voc => {
            serialisation::write_u16(model.voc(), buffer);
        },
        Point::TodaySMaximumVoc => {
            serialisation::write_u16(model.today_s_maximum_voc(), buffer);
        },
        Point::TodaySKWh => {
            serialisation::write_u16(model.today_s_k_wh(), buffer);
        },
        Point::TodaySAh => {
            serialisation::write_u16(model.today_s_ah(), buffer);
        },
        Point::LifetimeKWh => {
            serialisation::write_u16(model.lifetime_k_wh(), buffer);
        },
        Point::LifetimeKAh => {
            serialisation::write_u16(model.lifetime_k_ah(), buffer);
        },
