...
pub struct Model707CallbackAdapter {
    ...
    ///
    /// DER low voltage trip control enable.
    der_trip_lv_module_enable_callback: extern "C" fn(*const c_void) -> Model707Ena,
    /// DER Trip LV Module Enable (Ena)
    ///
    /// DER low voltage trip control enable.
    set_der_trip_lv_module_enable_callback: extern "C" fn(Model707Ena, *mut c_void),
    /// Adopt Curve Request (AdptCrvReq)
    ///
    /// Index of curve points to adopt. First curve index is 1.
    ...
    ///
    /// Result of last adopt curve operation.
    adopt_curve_result_callback: extern "C" fn(*const c_void) -> Model707AdptCrvRslt,
    /// Number Of Points (NPt)
    ///
    /// Number of curve points supported.
    ...
    ///
    /// Curve read-write access.
    crv_curve_access_callback: extern "C" fn(*const c_void, u16) -> Model707ReadOnly,
    /// Number Of Active Points (ActPt)
    ///
    /// Number of active points in must trip curve.
...
impl ReadAdapter for Model707CallbackAdapter {
    fn der_trip_lv_module_enable(&self) -> Ena {
...
impl WriteAdapter for Model707CallbackAdapter {
    /// DER Trip LV Module Enable (Ena)
    ///
    /// DER low voltage trip control enable.
    fn set_der_trip_lv_module_enable(&mut self, value: Ena) {
...
#[repr(C)]
pub struct Model707StatefulAdapter<const STORED_CURVE_COUNT: usize, const NUMBER_OF_POINTS: usize> {
    /// DER Trip LV Module Enable (Ena)
    ///
    /// DER low voltage trip control enable.
    pub der_trip_lv_module_enable: Model707Ena,
    /// Adopt Curve Request (AdptCrvReq)
    ///
    /// Index of curve points to adopt. First curve index is 1.
    ...
    ///
    /// Result of last adopt curve operation.
    pub adopt_curve_result: Model707AdptCrvRslt,
    /// Number Of Points (NPt)
    ///
    /// Number of curve points supported.
    pub number_of_points: u16,
    ...
    pub stored_curves: [Model707StoredCurves<NUMBER_OF_POINTS>; STORED_CURVE_COUNT],
}

#[repr(C)]
pub struct Model707StoredCurves<const NUMBER_OF_POINTS: usize> {
    /// Curve Access (ReadOnly)
    ///
    /// Curve read-write access.
    pub crv_curve_access: Model707ReadOnly,
    /// Number Of Active Points (ActPt)
    ///
    /// Number of active points in must trip curve.
    ...
    pub must_trip_curve_must_trip_curve_points:
        [Model707MustTripCurveMustTripCurvePoints; NUMBER_OF_POINTS],
    pub may_trip_curve_may_trip_curve_points:
        [Model707MayTripCurveMayTripCurvePoints; NUMBER_OF_POINTS],
    pub momentary_cessation_curve_mom_cessation_curve_points:
        [Model707MomentaryCessationCurveMomCessationCurvePoints; NUMBER_OF_POINTS],
}

#[repr(C)]
pub struct Model707MustTripCurveMustTripCurvePoints {
    /// Voltage Point (V)
    ///
    /// Curve voltage point as percentage.
    ///
    /// Internal curve conformance checks should be conducted when AdptCrvReq is set to 1, not on point writes.
    pub must_trip_curve_pt_voltage_point: u16,
    /// Time Point (Tms)
    ///
    /// Curve time point in seconds.
    ///
...
#[repr(C)]
pub struct Model707MayTripCurveMayTripCurvePoints {
    /// Voltage Point (V)
    ///
    /// Curve voltage point as percentage.
    pub may_trip_curve_pt_voltage_point: u16,
    /// Time Point (Tms)
    ///
    /// Curve time point in seconds.
...
#[repr(C)]
pub struct Model707MomentaryCessationCurveMomCessationCurvePoints {
    /// Voltage Point (V)
    ///
    /// Curve voltage point as percentage.
    pub momentary_cessation_curve_pt_voltage_point: u16,
    /// Time Point (Tms)
    ///
    /// Curve time point in seconds.
...
impl<const STORED_CURVE_COUNT: usize, const NUMBER_OF_POINTS: usize> ReadAdapter
    for Model707StatefulAdapter<STORED_CURVE_COUNT, NUMBER_OF_POINTS>
{
    fn der_trip_lv_module_enable(&self) -> Ena {
    ...
    fn may_trip_curve_pt_voltage_point(&self, crv_index: u16, pt_index: u16) -> Option<u16> {
        Some(
            self.stored_curves[crv_index as usize].may_trip_curve_may_trip_curve_points
                [pt_index as usize]
                .may_trip_curve_pt_voltage_point,
        )
    }
    ...
    for Model707StatefulAdapter<STORED_CURVE_COUNT, NUMBER_OF_POINTS>
{
    ...
    fn set_must_trip_curve_pt_voltage_point(&mut self, value: u16, crv_index: u16, pt_index: u16) {
        self.stored_curves[crv_index as usize].must_trip_curve_must_trip_curve_points
            [pt_index as usize]
            .must_trip_curve_pt_voltage_point = value;
    }
    ...
    fn set_may_trip_curve_pt_voltage_point(&mut self, value: u16, crv_index: u16, pt_index: u16) {
        self.stored_curves[crv_index as usize].may_trip_curve_may_trip_curve_points
            [pt_index as usize]
            .may_trip_curve_pt_voltage_point = value;
    }
    ...
    fn set_momentary_cessation_curve_pt_voltage_point(
        ...
        self.stored_curves[crv_index as usize]
            .momentary_cessation_curve_mom_cessation_curve_points[pt_index as usize]
            .momentary_cessation_curve_pt_voltage_point = value;
    }
...
/// C-FFI dispatch descriptor for SunSpec model 707. A C `SunspecModelBinding` points
/// at this static, so the service functions dispatch with no model-id lookup.
#[unsafe(no_mangle)]
pub static SUNSPEC_MODEL_707: StaticModelSpec = StaticModelSpec {
    id: 707,
    length: model_707_c_length,
    writable: true,
    visit_read: model_707_c_visit_read,
    visit_write: model_707_c_visit_write,
};

fn model_707_c_length(repeat_count_0: u16, repeat_count_1: u16) -> u16 {
    (Model707 {
...
/// # Safety
/// For `kind` 1 or 2, `adapter` must point to a live `Model707{Stateful,Callback}Adapter`,
/// valid for the duration of the call.
unsafe fn model_707_c_visit_read(
    kind: u8,
    ...
    let adapter: Option<&dyn ReadAdapter> = match kind {
        2 => Some(unsafe { &*(adapter as *const Model707CallbackAdapter) } as &dyn ReadAdapter),
        _ => None,
    };
...
/// # Safety
/// As for [`model_707_c_visit_read`], and `adapter` must be uniquely borrowable for the call.
unsafe fn model_707_c_visit_write(
    kind: u8,
    adapter: *mut c_void,
    repeat_count_0: u16,
    repeat_count_1: u16,
    ...
    let adapter: Option<&mut dyn WriteAdapter> = match kind {
        2 => {
            Some(unsafe { &mut *(adapter as *mut Model707CallbackAdapter) } as &mut dyn WriteAdapter)
        }
        _ => None,
    };
