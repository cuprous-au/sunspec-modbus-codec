...
pub static POINTS: [ReadablePoint; 45] = [
    ReadablePoint {
        reference: PointReference::Static { value: 103 },
        size: 1,
    ...
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::Amps },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::AmpsPhaseA },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::AmpsPhaseB },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::AmpsPhaseC },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::ASf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::PhaseVoltageAb },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::PhaseVoltageBc },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::PhaseVoltageCa },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::PhaseVoltageAn },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::PhaseVoltageBn },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::PhaseVoltageCn },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::VSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::Watts },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::WSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::Hz },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::HzSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::Va },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::VaSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::VAr },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::VArSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::Pf },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::PfSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::WattHours },
        size: 2,
        data_type: PointType::Acc32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::WhSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::DcAmps },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::DcaSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::DcVoltage },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::DcvSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::DcWatts },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::DcwSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::CabinetTemperature },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::HeatSinkTemperature },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::TransformerTemperature },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::OtherTemperature },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::TmpSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::OperatingState },
        size: 1,
        data_type: PointType::Enum16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::VendorOperatingState },
        size: 1,
        data_type: PointType::Enum16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::Event1 },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::EventBitfield2 },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::VendorEventBitfield1 },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::VendorEventBitfield2 },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::VendorEventBitfield3 },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model103 { point: Point::VendorEventBitfield4 },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::Amps => {
            serialisation::write_u16(model.amps(), buffer);
        },
        Point::AmpsPhaseA => {
            serialisation::write_u16(model.amps_phase_a(), buffer);
        },
        Point::AmpsPhaseB => {
            serialisation::write_u16(model.amps_phase_b(), buffer);
        },
        Point::AmpsPhaseC => {
            serialisation::write_u16(model.amps_phase_c(), buffer);
        },
        Point::ASf => {
        ...
        Point::PhaseVoltageAn => {
            serialisation::write_u16(model.phase_voltage_an(), buffer);
        },
        Point::PhaseVoltageBn => {
            serialisation::write_u16(model.phase_voltage_bn(), buffer);
        },
        Point::PhaseVoltageCn => {
            serialisation::write_u16(model.phase_voltage_cn(), buffer);
        },
        Point::VSf => {
        ...
        Point::Hz => {
            serialisation::write_u16(model.hz(), buffer);
        },
        Point::HzSf => {
        ...
        Point::WhSf => {
            serialisation::write_u16(model.wh_sf(), buffer);
        },
        Point::DcAmps => {
        ...
        Point::CabinetTemperature => {
            serialisation::write_i16(model.cabinet_temperature(), buffer);
        },
        ...
        Point::TmpSf => {
            serialisation::write_u16(model.tmp_sf(), buffer);
        },
        Point::OperatingState => {
            serialisation::write_u16(model.operating_state() as u16, buffer);
        },
        ...
        Point::Event1 => {
            serialisation::write_u32(model.event1(), buffer, offset, limit);
        },
...
impl ModelAdapter for Model103CallbackAdapter {
    /// Amps
    ///
    /// AC Current
    ///
    ...
    /// AC Reactive Power
    fn v_ar(&self) -> Option<i16> {
        self.v_ar_callback.map(|callback| {
        (callback)(self.context)
        })
    }

    fn v_ar_sf(&self) -> Option<u16> {
        self.v_ar_sf_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// DC Current
    fn dc_amps(&self) -> Option<u16> {
        self.dc_amps_callback.map(|callback| {
        (callback)(self.context)
        })
    }

    fn dca_sf(&self) -> Option<u16> {
        self.dca_sf_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// DC Voltage
    fn dc_voltage(&self) -> Option<u16> {
        self.dc_voltage_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// DC Power
    fn dc_watts(&self) -> Option<i16> {
        self.dc_watts_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Vendor specific operating state code
    fn vendor_operating_state(&self) -> Option<u16> {
        self.vendor_operating_state_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Vendor defined events
    fn vendor_event_bitfield_1(&self) -> Option<u32> {
        self.vendor_event_bitfield_1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Vendor defined events
    fn vendor_event_bitfield_2(&self) -> Option<u32> {
        self.vendor_event_bitfield_2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Vendor defined events
    fn vendor_event_bitfield_3(&self) -> Option<u32> {
        self.vendor_event_bitfield_3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Vendor defined events
    fn vendor_event_bitfield_4(&self) -> Option<u32> {
        self.vendor_event_bitfield_4_callback.map(|callback| {
        (callback)(self.context)
        })
    }
}
...
impl ModelAdapter for Model103StatefulAdapter {
    /// Amps
    ///
    /// AC Current
    ///
