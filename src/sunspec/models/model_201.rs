...
pub struct Model201CallbackAdapter {
    ...
    amps_phase_b_callback: Option<extern "C" fn() -> i16>,
    amps_phase_c_callback: Option<extern "C" fn() -> i16>,
    ...
    voltage_ll_callback: Option<extern "C" fn() -> i16>,
    phase_voltage_ab_callback: Option<extern "C" fn() -> i16>,
