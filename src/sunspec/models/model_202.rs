...
pub static POINTS: [ReadablePoint; 74] = [
    ...
    ReadablePoint {
        reference: PointReference::Model202 {
...
pub struct Model202CallbackAdapter {
    ...
    amps_phase_a_callback: Option<extern "C" fn() -> i16>,
    ...
    phase_voltage_bc_callback: Option<extern "C" fn() -> i16>,
    phase_voltage_ca_callback: Option<extern "C" fn() -> i16>,
...
impl ModelAdapter for Model202CallbackAdapter {
    ...
    /// Phase A Current
    fn amps_phase_a(&self) -> Option<i16> {
        self.amps_phase_a_callback.map(|callback| (callback)())
    }
