...
pub static POINTS: [ReadablePoint; 23] = [
    ...
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::Status },
        size: 1,
        data_type: PointType::Enum16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::VendorStatus },
        size: 1,
        data_type: PointType::Enum16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::Events },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::VendorModuleEventFlags },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::Control },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::VendorControl },
        size: 2,
        data_type: PointType::Enum32,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::ControlValue },
        size: 2,
        data_type: PointType::Int32,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::Timestamp },
        size: 2,
        data_type: PointType::Uint32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::OutputCurrent },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::OutputVoltage },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::OutputEnergy },
        size: 2,
        data_type: PointType::Acc32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::OutputPower },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ...
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::InputCurrent },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::InputVoltage },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::InputEnergy },
        size: 2,
        data_type: PointType::Acc32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model502 { point: Point::InputPower },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::ASf => if let Some(value) = model.a_sf() { serialisation::write_u16(value, buffer); },
        ...
        Point::WhSf => if let Some(value) = model.wh_sf() { serialisation::write_u16(value, buffer); },
        ...
        Point::OutputCurrent => if let Some(value) = model.output_current() { serialisation::write_i16(value, buffer); },
        Point::OutputVoltage => if let Some(value) = model.output_voltage() { serialisation::write_i16(value, buffer); },
        Point::OutputEnergy => if let Some(value) = model.output_energy() { serialisation::write_u32(value, buffer, offset, limit); },
        Point::OutputPower => if let Some(value) = model.output_power() { serialisation::write_i16(value, buffer); },
        Point::Temp => if let Some(value) = model.temp() { serialisation::write_i16(value, buffer); },
        Point::InputCurrent => if let Some(value) = model.input_current() { serialisation::write_i16(value, buffer); },
        Point::InputVoltage => if let Some(value) = model.input_voltage() { serialisation::write_i16(value, buffer); },
        Point::InputEnergy => if let Some(value) = model.input_energy() { serialisation::write_u32(value, buffer, offset, limit); },
        Point::InputPower => if let Some(value) = model.input_power() { serialisation::write_i16(value, buffer); },
    }
}
