...
use sunspec_modbus_lib_rs::sunspec::models::model_204::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model204CallbackAdapter`, valid for the
...
unsafe fn model_204_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model204CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_204_callback(
    adapter: *mut Model204CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_204,
