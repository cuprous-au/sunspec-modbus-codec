...
pub static POINTS: [ReadablePoint; 9] = [
    ...
    ReadablePoint {
        reference: PointReference::Model710 { point: Point::DerTripHfModuleEnable },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model710 { point: Point::AdoptCurveRequest },
        size: 1,
        data_type: PointType::Uint16,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model710 { point: Point::AdoptCurveResult },
        size: 1,
        data_type: PointType::Enum16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model710 { point: Point::NumberOfPoints },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model710 { point: Point::StoredCurveCount },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model710 { point: Point::FrequencyScaleFactor },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model710 { point: Point::TimePointScaleFactor },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::DerTripHfModuleEnable => {
            serialisation::write_u16(model.der_trip_hf_module_enable() as u16, buffer);
        },
...
#[repr(C)]
pub struct Model710StatefulAdapter {
...
impl ModelAdapter for Model710StatefulAdapter {
    /// DER Trip HF Module Enable
    ///
    /// DER high frequency trip control enable.
    fn der_trip_hf_module_enable(&self) -> Ena {
