...
use sunspec_modbus_lib_rs::sunspec::models::model_202::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model202CallbackAdapter`, valid for the
...
unsafe fn model_202_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model202CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_202_callback(
    adapter: *mut Model202CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_202,
