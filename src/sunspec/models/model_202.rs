...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        ...
        Point::AmpsPhaseA => {
            if let Some(value) = model.amps_phase_a() {
...
impl ModelAdapter for Model202CallbackAdapter {
    /// Amps
    ///
    /// Total AC Current
    fn amps(&self) -> i16 {
    ...
    /// Phase A Current
    fn amps_phase_a(&self) -> Option<i16> {
        self.amps_phase_a_callback.map(|callback| {
...
impl ModelAdapter for Model202StatefulAdapter {
    /// Amps
    ///
    /// Total AC Current
    fn amps(&self) -> i16 {
