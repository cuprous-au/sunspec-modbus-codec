...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        ...
        Point::AmpsPhaseB => if let Some(value) = model.amps_phase_b() { serialisation::write_u16(value, buffer); },
        Point::AmpsPhaseC => if let Some(value) = model.amps_phase_c() { serialisation::write_u16(value, buffer); },
        ...
        Point::PhaseVoltageBn => if let Some(value) = model.phase_voltage_bn() { serialisation::write_u16(value, buffer); },
        Point::PhaseVoltageCn => if let Some(value) = model.phase_voltage_cn() { serialisation::write_u16(value, buffer); },
