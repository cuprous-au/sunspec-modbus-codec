...
pub static POINTS: [ReadablePoint; 9] = [
    ReadablePoint {
        reference: PointReference::Static { value: 707 },
        size: 1,
...
pub fn write_point<'a>(
    ...
    match point {
        ...
        Point::DerTripLvModuleEnable => {
            buffer::write_u16(model.der_trip_lv_module_enable() as u16, buffer);
        }
...
pub struct Model707CallbackAdapter {
    context: *mut c_void,
    der_trip_lv_module_enable_callback: extern "C" fn(*const c_void) -> Ena,
    set_der_trip_lv_module_enable_callback: extern "C" fn(Ena, *mut c_void),
...
impl ModelAdapter for Model707CallbackAdapter {
    ...
    /// DER low voltage trip control enable.
    fn der_trip_lv_module_enable(&self) -> Ena {
        (self.der_trip_lv_module_enable_callback)(self.context)
    }
    ...
    /// DER low voltage trip control enable.
    fn set_der_trip_lv_module_enable(&mut self, value: Ena) {
        (self.set_der_trip_lv_module_enable_callback)(value, self.context);
    }
...
#[repr(C)]
pub struct Model707StatefulAdapter<const STORED_CURVE_COUNT: usize> {
    der_trip_lv_module_enable: Ena,
    ...
    stored_curves: [Model707StoredCurves; STORED_CURVE_COUNT],
}

#[repr(C)]
pub struct Model707StoredCurves {
...
impl<const STORED_CURVE_COUNT: usize> ModelAdapter for Model707StatefulAdapter<STORED_CURVE_COUNT> {
    /// DER Trip LV Module Enable
    ///
    /// DER low voltage trip control enable.
    fn der_trip_lv_module_enable(&self) -> Ena {
        self.der_trip_lv_module_enable
    }
    ...
    /// DER low voltage trip control enable.
    fn set_der_trip_lv_module_enable(&mut self, value: Ena) {
        self.der_trip_lv_module_enable = value;
    }
