...
pub struct AcMeterAnOrAb {
    ...
    pp_vph_ab: Option<i16>,
    /// Phase Voltage BC
    ///
    /// Phase Voltage BC
    pp_vph_bc: Option<i16>,
    /// Phase Voltage CA
    ///
    /// Phase Voltage CA
    pp_vph_ca: Option<i16>,
