...
use sunspec_modbus_lib_rs::sunspec::models::model_211::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model211CallbackAdapter`, valid for the
...
unsafe fn model_211_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model211CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_211_callback(
    adapter: *mut Model211CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_211,
