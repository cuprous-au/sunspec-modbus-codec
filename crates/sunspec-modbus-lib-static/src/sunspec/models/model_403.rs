...
use sunspec_modbus_lib_rs::sunspec::models::model_403::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model403CallbackAdapter`, valid for the
...
unsafe fn model_403_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model403CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_403_callback(
    adapter: *mut Model403CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_403,
