...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::PermitEnterService => if let Some(value) = model.permit_enter_service() { serialisation::write_u16(value as u16, buffer); },
        Point::EnterServiceVoltageHigh => if let Some(value) = model.enter_service_voltage_high() { serialisation::write_u16(value, buffer); },
        Point::EnterServiceVoltageLow => if let Some(value) = model.enter_service_voltage_low() { serialisation::write_u16(value, buffer); },
        Point::EnterServiceFrequencyHigh => if let Some(value) = model.enter_service_frequency_high() { serialisation::write_u32(value, buffer, offset, limit); },
        Point::EnterServiceFrequencyLow => if let Some(value) = model.enter_service_frequency_low() { serialisation::write_u32(value, buffer, offset, limit); },
        Point::EnterServiceDelayTime => if let Some(value) = model.enter_service_delay_time() { serialisation::write_u32(value, buffer, offset, limit); },
        Point::EnterServiceRandomDelay => if let Some(value) = model.enter_service_random_delay() { serialisation::write_u32(value, buffer, offset, limit); },
        Point::EnterServiceRampTime => if let Some(value) = model.enter_service_ramp_time() { serialisation::write_u32(value, buffer, offset, limit); },
        Point::EnterServiceDelayRemaining => if let Some(value) = model.enter_service_delay_remaining() { serialisation::write_u32(value, buffer, offset, limit); },
