...
use sunspec_modbus_lib_rs::sunspec::models::model_101::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model101CallbackAdapter`, valid for the
...
unsafe fn model_101_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model101CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_101_callback(
    adapter: *mut Model101CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_101,
