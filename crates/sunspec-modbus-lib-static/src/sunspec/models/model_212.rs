...
use sunspec_modbus_lib_rs::sunspec::models::model_212::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model212CallbackAdapter`, valid for the
...
unsafe fn model_212_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model212CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_212_callback(
    adapter: *mut Model212CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_212,
