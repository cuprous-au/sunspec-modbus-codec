...
pub static POINTS: [ReadablePoint; 9] = [
    ...
    ReadablePoint {
        reference: PointReference::Model708 { point: Point::DerTripHvModuleEnable },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model708 { point: Point::AdoptCurveRequest },
        size: 1,
        data_type: PointType::Uint16,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model708 { point: Point::AdoptCurveResult },
        size: 1,
        data_type: PointType::Enum16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model708 { point: Point::NumberOfPoints },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model708 { point: Point::StoredCurveCount },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model708 { point: Point::VoltageScaleFactor },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model708 { point: Point::TimePointScaleFactor },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::DerTripHvModuleEnable => {
            serialisation::write_u16(model.der_trip_hv_module_enable() as u16, buffer);
        },
...
#[repr(C)]
pub struct Model708StatefulAdapter {
...
impl ModelAdapter for Model708StatefulAdapter {
    /// DER Trip HV Module Enable
    ///
    /// DER high voltage trip control enable.
    fn der_trip_hv_module_enable(&self) -> Ena {
