...
pub static POINTS: [ReadablePoint; 3] = [
    ...
    ReadablePoint {
        reference: PointReference::Model809 { point: Point::StackPointsToBeDetermined },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::StackPointsToBeDetermined => serialisation::write_u16(model.stack_points_to_be_determined(), buffer),
    }
}
