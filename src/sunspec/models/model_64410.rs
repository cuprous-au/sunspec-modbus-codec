...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        ...
        Point::PowerScaleFactor => {
            serialisation::write_u16(model.power_scale_factor(), buffer);
        },
        ...
        Point::PercentScaleFactor => {
            serialisation::write_u16(model.percent_scale_factor(), buffer);
        },
    }
}
...
impl ModelAdapter for Model64410CallbackAdapter {
    ...
    /// Upper Power Protection Limit
    fn maximum_power(&self) -> Option<u16> {
        self.maximum_power_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Constant Voltage (CV) or Constant Current (CC) Mode
    fn cv_or_cc_mode(&self) -> Option<Mode> {
        self.cv_or_cc_mode_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Power On/Off
    fn power_on_off(&self) -> Option<Ena> {
        self.power_on_off_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Reset Device
    fn reset_device(&self) -> Option<Reset> {
        self.reset_device_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Power Setpoint
    fn power_setpoint(&self) -> Option<u16> {
        self.power_setpoint_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Current Setpoint
    fn current_setpoint(&self) -> Option<u16> {
        self.current_setpoint_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// EN50530 Mode - Enable or disable EN50530 profile mode
    fn en50530_mode(&self) -> Option<En50530> {
        self.en50530_mode_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// EN50530 MPP Voltage
    fn en50530_mpp_voltage(&self) -> Option<u16> {
        self.en50530_mpp_voltage_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// EN50530 MPP Power
    fn en50530_mpp_power(&self) -> Option<u16> {
        self.en50530_mpp_power_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Irradiance Setpoint
    fn irradiance_setpoint(&self) -> Option<u16> {
        self.irradiance_setpoint_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Power Slew Rate
    fn power_slew_rate(&self) -> Option<u16> {
        self.power_slew_rate_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Current Slew Rate
    fn current_slew_rate(&self) -> Option<u16> {
        self.current_slew_rate_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Index of profile points to adopt. First curve index is 1.
    fn profile_adoption_request(&self) -> Option<u16> {
        self.profile_adoption_request_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measured Voltage
    fn measured_voltage(&self) -> Option<i32> {
        self.measured_voltage_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measured Power
    fn measured_power(&self) -> Option<i32> {
        self.measured_power_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measured Current
    fn measured_current(&self) -> Option<i32> {
        self.measured_current_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Error States
    fn errors(&self) -> Option<&CStr> {
        self.errors_callback.map(|callback| {
...
impl ModelAdapter for Model64410StatefulAdapter {
    ...
    fn errors(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.errors.as_ptr()) }
        )
    }
