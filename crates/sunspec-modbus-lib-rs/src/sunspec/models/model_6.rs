...
pub fn write_point<'a>(
    ...
    match point {
        ...
        Point::Offset => {
            buffer::write_u16(model.offset(), buffer);
        }
        Point::Value1 => {
        ...
        Point::Val51 => {
            buffer::write_u16(model.val51(), buffer);
        }
        Point::Val52 => {
            buffer::write_u16(model.val52(), buffer);
        }
        Point::Val53 => {
            buffer::write_u16(model.val53(), buffer);
        }
        Point::Val54 => {
            buffer::write_u16(model.val54(), buffer);
        }
        Point::Val55 => {
            buffer::write_u16(model.val55(), buffer);
        }
        Point::Val56 => {
            buffer::write_u16(model.val56(), buffer);
        }
        Point::Val57 => {
            buffer::write_u16(model.val57(), buffer);
        }
        Point::Val58 => {
            buffer::write_u16(model.val58(), buffer);
        }
        Point::Val59 => {
            buffer::write_u16(model.val59(), buffer);
        }
        Point::Val60 => {
            buffer::write_u16(model.val60(), buffer);
        }
        Point::Val61 => {
            buffer::write_u16(model.val61(), buffer);
        }
        Point::Val62 => {
            buffer::write_u16(model.val62(), buffer);
        }
        Point::Val63 => {
            buffer::write_u16(model.val63(), buffer);
        }
        Point::Val64 => {
            buffer::write_u16(model.val64(), buffer);
        }
        Point::Val65 => {
            buffer::write_u16(model.val65(), buffer);
        }
        Point::Val66 => {
            buffer::write_u16(model.val66(), buffer);
        }
        Point::Val67 => {
            buffer::write_u16(model.val67(), buffer);
        }
        Point::Val68 => {
            buffer::write_u16(model.val68(), buffer);
        }
        Point::Val69 => {
            buffer::write_u16(model.val69(), buffer);
        }
        Point::Val70 => {
            buffer::write_u16(model.val70(), buffer);
        }
        Point::Val71 => {
            buffer::write_u16(model.val71(), buffer);
        }
        Point::Val72 => {
            buffer::write_u16(model.val72(), buffer);
        }
        Point::Val73 => {
            buffer::write_u16(model.val73(), buffer);
        }
        Point::Val74 => {
            buffer::write_u16(model.val74(), buffer);
        }
        Point::Val75 => {
            buffer::write_u16(model.val75(), buffer);
        }
        Point::Val76 => {
            buffer::write_u16(model.val76(), buffer);
        }
        Point::Val77 => {
            buffer::write_u16(model.val77(), buffer);
        }
        Point::Val78 => {
            buffer::write_u16(model.val78(), buffer);
        }
        Point::Val79 => {
            buffer::write_u16(model.val79(), buffer);
        }
        Point::Val80 => {
            buffer::write_u16(model.val80(), buffer);
        }
        Point::Timestamp => {
