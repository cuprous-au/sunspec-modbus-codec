...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        ...
        Point::PhaseVoltageCn => {
            serialisation::write_f32(model.phase_voltage_cn(), buffer, offset, limit);
        },
        Point::Watts => {
...
#[repr(C)]
pub struct Model113CallbackAdapter {
    context: *mut c_void,
...
impl ModelAdapter for Model113CallbackAdapter {
    /// Amps
    ///
    /// AC Current
    ///
...
#[repr(C)]
pub struct Model113StatefulAdapter {
    amps: f32,
    amps_phase_a: f32,
    amps_phase_b: f32,
    amps_phase_c: f32,
...
impl ModelAdapter for Model113StatefulAdapter {
    /// Amps
    ///
    /// AC Current
    ///
