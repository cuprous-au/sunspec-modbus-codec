...
use sunspec_modbus_lib_rs::sunspec::models::model_203::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model203CallbackAdapter`, valid for the
...
unsafe fn model_203_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model203CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_203_callback(
    adapter: *mut Model203CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_203,
