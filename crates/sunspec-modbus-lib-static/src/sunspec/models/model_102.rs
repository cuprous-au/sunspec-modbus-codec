...
use sunspec_modbus_lib_rs::sunspec::models::model_102::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model102CallbackAdapter`, valid for the
...
unsafe fn model_102_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model102CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_102_callback(
    adapter: *mut Model102CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_102,
