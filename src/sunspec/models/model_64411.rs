...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        ...
        Point::ProfileResult => {
            serialisation::write_u16(model.profile_result() as u16, buffer);
        },
        Point::StoredProfileCount => {
            serialisation::write_u16(model.stored_profile_count(), buffer);
        },
        ...
        Point::CurrentScaleFactor => {
            serialisation::write_u16(model.current_scale_factor(), buffer);
        },
        Point::TimeScaleFactor => {
            serialisation::write_u16(model.time_scale_factor(), buffer);
        },
        ...
        Point::ThdScaleFactor => {
            serialisation::write_u16(model.thd_scale_factor(), buffer);
        },
    }
}
...
impl ModelAdapter for Model64411CallbackAdapter {
    ...
    /// Set the number of active phases for the power supply
    fn active_phases(&self) -> Option<u16> {
        self.active_phases_callback.map(|callback| {
    ...
    /// Phase angle (deg) between phases. 0 for signle phase, 120 for two phase, 120 for three phase.
    fn phase_angle(&self) -> Option<u16> {
        self.phase_angle_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Nominal L-N Voltage
    fn nominal_voltage(&self) -> Option<u16> {
        self.nominal_voltage_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Maximum Voltage Protection Level
    fn maximum_voltage(&self) -> Option<u16> {
        self.maximum_voltage_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Maximum Current Protection Level
    fn maximum_current(&self) -> Option<u16> {
        self.maximum_current_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// AC Output State
    fn output_state(&self) -> Option<Output> {
        self.output_state_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// AC Relay State
    fn relay_state(&self) -> Option<Relay> {
        self.relay_state_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Regeneration State
    fn regeneration_state(&self) -> Option<Regen> {
        self.regeneration_state_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Voltage Setpoint (all phases)
    fn voltage_setpoint(&self) -> Option<u16> {
        self.voltage_setpoint_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Voltage Setpoint Phase A
    fn voltage_setpoint_phase_a(&self) -> Option<u16> {
        self.voltage_setpoint_phase_a_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Voltage Setpoint Phase B
    fn voltage_setpoint_phase_b(&self) -> Option<u16> {
        self.voltage_setpoint_phase_b_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Voltage Setpoint Phase C
    fn voltage_setpoint_phase_c(&self) -> Option<u16> {
        self.voltage_setpoint_phase_c_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Frequency Slew Rate
    fn frequency_slew_rate(&self) -> Option<u16> {
        self.frequency_slew_rate_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Voltage Slew Rate
    fn voltage_slew_rate(&self) -> Option<u16> {
        self.voltage_slew_rate_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measured Voltage Phase A
    fn measured_voltage_phase_a(&self) -> Option<i32> {
        self.measured_voltage_phase_a_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measured Voltage Phase B
    fn measured_voltage_phase_b(&self) -> Option<i32> {
        self.measured_voltage_phase_b_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measured Voltage Phase C
    fn measured_voltage_phase_c(&self) -> Option<i32> {
        self.measured_voltage_phase_c_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measured Frequency
    fn measured_frequency(&self) -> Option<i32> {
        self.measured_frequency_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measured Current Phase A
    fn measured_current_phase_a(&self) -> Option<i32> {
        self.measured_current_phase_a_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measured Current Phase B
    fn measured_current_phase_b(&self) -> Option<i32> {
        self.measured_current_phase_b_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measured Current Phase C
    fn measured_current_phase_c(&self) -> Option<i32> {
        self.measured_current_phase_c_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Voltage Harmonics Pct, Phase A (comma seperated string for harmonics 1-50)
    fn voltage_harmonics_phase_a(&self) -> Option<&CStr> {
        self.voltage_harmonics_phase_a_callback.map(|callback| {
    ...
    /// Voltage Harmonics Pct, Phase B (comma seperated string for harmonics 1-50)
    fn voltage_harmonics_phase_b(&self) -> Option<&CStr> {
        self.voltage_harmonics_phase_b_callback.map(|callback| {
        unsafe { CStr::from_ptr((callback)(self.context)) }
        })
    }
    ...
    /// Voltage Harmonics Pct, Phase C (comma seperated string for harmonics 1-50)
    fn voltage_harmonics_phase_c(&self) -> Option<&CStr> {
        self.voltage_harmonics_phase_c_callback.map(|callback| {
        unsafe { CStr::from_ptr((callback)(self.context)) }
        })
    }
    ...
    /// Current Harmonics Pct, Phase A (comma seperated string for harmonics 1-50)
    fn current_harmonics_phase_a(&self) -> Option<&CStr> {
        self.current_harmonics_phase_a_callback.map(|callback| {
        unsafe { CStr::from_ptr((callback)(self.context)) }
        })
    }
    ...
    /// Current Harmonics Pct, Phase B (comma seperated string for harmonics 1-50)
    fn current_harmonics_phase_b(&self) -> Option<&CStr> {
        self.current_harmonics_phase_b_callback.map(|callback| {
        unsafe { CStr::from_ptr((callback)(self.context)) }
        })
    }
    ...
    /// Current Harmonics Pct, Phase C (comma seperated string for harmonics 1-50)
    fn current_harmonics_phase_c(&self) -> Option<&CStr> {
        self.current_harmonics_phase_c_callback.map(|callback| {
        unsafe { CStr::from_ptr((callback)(self.context)) }
        })
    }
    ...
    /// Current Interharmonics Pct, Phase A (comma seperated string for interharmonics 1-50)
    fn current_interharmonics_phase_a(&self) -> Option<&CStr> {
        self.current_interharmonics_phase_a_callback.map(|callback| {
        unsafe { CStr::from_ptr((callback)(self.context)) }
        })
    }
    ...
    /// Current Interharmonics Pct, Phase B (comma seperated string for interharmonics 1-50)
    fn current_interharmonics_phase_b(&self) -> Option<&CStr> {
        self.current_interharmonics_phase_b_callback.map(|callback| {
        unsafe { CStr::from_ptr((callback)(self.context)) }
        })
    }
    ...
    /// Current Interharmonics Pct, Phase C (comma seperated string for interharmonics 1-50)
    fn current_interharmonics_phase_c(&self) -> Option<&CStr> {
        self.current_interharmonics_phase_c_callback.map(|callback| {
        unsafe { CStr::from_ptr((callback)(self.context)) }
        })
    }
    ...
    /// Voltage THD Phase A
    fn voltage_thd_phase_a(&self) -> Option<u16> {
        self.voltage_thd_phase_a_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Voltage THD Phase B
    fn voltage_thd_phase_b(&self) -> Option<u16> {
        self.voltage_thd_phase_b_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Voltage THD Phase C
    fn voltage_thd_phase_c(&self) -> Option<u16> {
        self.voltage_thd_phase_c_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Current THD Phase A
    fn current_thd_phase_a(&self) -> Option<u16> {
        self.current_thd_phase_a_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Current THD Phase B
    fn current_thd_phase_b(&self) -> Option<u16> {
        self.current_thd_phase_b_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Current THD Phase C
    fn current_thd_phase_c(&self) -> Option<u16> {
        self.current_thd_phase_c_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Start/Stop the AC Profile
    fn enable_profile(&self) -> Option<EnaProf> {
        self.enable_profile_callback.map(|callback| {
        (callback)(self.context)
        })
    }
...
impl ModelAdapter for Model64411StatefulAdapter {
    ...
    fn voltage_harmonics_phase_a(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.voltage_harmonics_phase_a.as_ptr()) }
        )
    }
    ...
    fn voltage_harmonics_phase_b(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.voltage_harmonics_phase_b.as_ptr()) }
        )
    }
    ...
    fn voltage_harmonics_phase_c(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.voltage_harmonics_phase_c.as_ptr()) }
        )
    }
    ...
    fn current_harmonics_phase_a(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.current_harmonics_phase_a.as_ptr()) }
        )
    }
    ...
    fn current_harmonics_phase_b(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.current_harmonics_phase_b.as_ptr()) }
        )
    }
    ...
    fn current_harmonics_phase_c(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.current_harmonics_phase_c.as_ptr()) }
        )
    }
    ...
    fn current_interharmonics_phase_a(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.current_interharmonics_phase_a.as_ptr()) }
        )
    }
    ...
    fn current_interharmonics_phase_b(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.current_interharmonics_phase_b.as_ptr()) }
        )
    }
    ...
    fn current_interharmonics_phase_c(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.current_interharmonics_phase_c.as_ptr()) }
        )
    }
