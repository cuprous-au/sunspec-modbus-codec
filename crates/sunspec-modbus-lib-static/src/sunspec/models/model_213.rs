...
use sunspec_modbus_lib_rs::sunspec::models::model_213::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model213CallbackAdapter`, valid for the
...
unsafe fn model_213_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model213CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_213_callback(
    adapter: *mut Model213CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_213,
