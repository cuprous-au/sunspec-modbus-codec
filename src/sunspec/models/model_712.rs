...
pub static POINTS: [ReadablePoint; 12] = [
    ...
    ReadablePoint {
        reference: PointReference::Model712 { point: Point::SetActiveCurveRequest },
        size: 1,
        data_type: PointType::Uint16,
        writeable: true,
    },
...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::DerWattVarModuleEnable => serialisation::write_u16(model.der_watt_var_module_enable() as u16, buffer),
        Point::SetActiveCurveRequest => serialisation::write_u16(model.set_active_curve_request(), buffer),
        Point::SetActiveCurveResult => serialisation::write_u16(model.set_active_curve_result() as u16, buffer),
        ...
        Point::ActivePowerScaleFactor => serialisation::write_u16(model.active_power_scale_factor(), buffer),
