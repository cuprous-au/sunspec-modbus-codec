...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        ...
        Point::InterfaceType => if let Some(value) = model.interface_type() { serialisation::write_u16(value as u16, buffer); },
        Point::Protocol => if let Some(value) = model.protocol() { serialisation::write_u16(value as u16, buffer); },
    }
}
