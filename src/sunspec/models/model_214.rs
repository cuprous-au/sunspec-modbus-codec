...
pub static POINTS: [ReadablePoint; 64] = [
    ...
    ReadablePoint {
        reference: PointReference::Model214 {
...
pub struct Model214CallbackAdapter {
    ...
    voltage_ll_callback: extern "C" fn() -> f32,
    phase_voltage_ab_callback: extern "C" fn() -> f32,
    phase_voltage_bc_callback: extern "C" fn() -> f32,
    phase_voltage_ca_callback: extern "C" fn() -> f32,
