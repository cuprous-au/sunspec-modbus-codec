...
use sunspec_modbus_lib_rs::sunspec::models::model_113::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model113CallbackAdapter`, valid for the
...
unsafe fn model_113_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model113CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_113_callback(
    adapter: *mut Model113CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_113,
