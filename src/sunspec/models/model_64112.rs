...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::PortNumber => {
            serialisation::write_u16(model.port_number(), buffer);
        },
        Point::VSf => {
            serialisation::write_u16(model.v_sf(), buffer);
        },
        Point::CSf => {
            serialisation::write_u16(model.c_sf(), buffer);
        },
        Point::HSf => {
            serialisation::write_u16(model.h_sf(), buffer);
        },
        Point::PSf => {
            serialisation::write_u16(model.p_sf(), buffer);
        },
        Point::AhSf => {
            serialisation::write_u16(model.ah_sf(), buffer);
        },
        Point::KwhSf => {
            serialisation::write_u16(model.kwh_sf(), buffer);
        },
        Point::Faults => {
            serialisation::write_u16(model.faults(), buffer);
        },
        Point::Absorb => {
            serialisation::write_u16(model.absorb(), buffer);
        },
        Point::AbsorbTime => {
            serialisation::write_u16(model.absorb_time(), buffer);
        },
        Point::AbsorbEnd => {
            serialisation::write_u16(model.absorb_end(), buffer);
        },
        Point::Rebulk => {
            serialisation::write_u16(model.rebulk(), buffer);
        },
        Point::Float => {
            serialisation::write_u16(model.float(), buffer);
        },
        Point::MaximumCharge => {
            serialisation::write_u16(model.maximum_charge(), buffer);
        },
        Point::Equalize => {
            serialisation::write_u16(model.equalize(), buffer);
        },
        Point::EqualizeTime => {
            serialisation::write_u16(model.equalize_time(), buffer);
        },
        Point::AutoEqualizeInterval => {
            serialisation::write_u16(model.auto_equalize_interval(), buffer);
        },
        Point::MpptMode => {
            serialisation::write_u16(model.mppt_mode() as u16, buffer);
        },
        Point::SweepWidth => {
            serialisation::write_u16(model.sweep_width() as u16, buffer);
        },
        Point::SweepMaximum => {
            serialisation::write_u16(model.sweep_maximum() as u16, buffer);
        },
        Point::UPickPwmDutyCycle => {
            serialisation::write_u16(model.u_pick_pwm_duty_cycle(), buffer);
        },
        Point::GridTieMode => {
            serialisation::write_u16(model.grid_tie_mode() as u16, buffer);
        },
        Point::TempCompMode => {
            serialisation::write_u16(model.temp_comp_mode() as u16, buffer);
        },
        ...
        Point::WakeupVocChange => {
            serialisation::write_u16(model.wakeup_voc_change(), buffer);
        },
        Point::SnoozeMode => {
            serialisation::write_u16(model.snooze_mode(), buffer);
        },
        Point::WakeupInterval => {
            serialisation::write_u16(model.wakeup_interval(), buffer);
        },
        Point::AuxOutputMode => {
            serialisation::write_u16(model.aux_output_mode() as u16, buffer);
        },
        Point::AuxOutputControl => {
            serialisation::write_u16(model.aux_output_control() as u16, buffer);
        },
        Point::AuxOutputState => {
            serialisation::write_u16(model.aux_output_state() as u16, buffer);
        },
        ...
        Point::AuxVentFan => {
            serialisation::write_u16(model.aux_vent_fan(), buffer);
        },
        Point::AuxPvTrigger => {
            serialisation::write_u16(model.aux_pv_trigger(), buffer);
        },
        ...
        Point::AuxDivertHoldTime => {
            serialisation::write_u16(model.aux_divert_hold_time(), buffer);
        },
        Point::AuxDivertDelayTime => {
            serialisation::write_u16(model.aux_divert_delay_time(), buffer);
        },
        Point::AuxDivertRelative => {
            serialisation::write_u16(model.aux_divert_relative(), buffer);
        },
        ...
        Point::DataLogDailyAh => {
            serialisation::write_u16(model.data_log_daily_ah(), buffer);
        },
        Point::DataLogDailyKWh => {
            serialisation::write_u16(model.data_log_daily_k_wh(), buffer);
        },
        ...
        Point::DataLogClear => {
            serialisation::write_u16(model.data_log_clear(), buffer);
        },
