...
pub static POINTS: [ReadablePoint; 9] = [
    ...
    ReadablePoint {
        reference: PointReference::Model64101 {
...
pub struct Model64101CallbackAdapter {
    eltek_country_code_callback: Option<extern "C" fn() -> u16>,
    eltek_feeding_phase_callback: Option<extern "C" fn() -> u16>,
    eltek_apd_method_callback: Option<extern "C" fn() -> u16>,
    eltek_apd_power_ref_callback: Option<extern "C" fn() -> u16>,
    eltek_rps_method_callback: Option<extern "C" fn() -> u16>,
    eltek_rps_q_ref_callback: Option<extern "C" fn() -> u16>,
    eltek_rps_cos_phi_ref_callback: Option<extern "C" fn() -> i16>,
}
...
impl ModelAdapter for Model64101CallbackAdapter {
    ...
    fn eltek_apd_method(&self) -> Option<u16> {
        self.eltek_apd_method_callback.map(|callback| (callback)())
    }
    ...
    fn eltek_rps_method(&self) -> Option<u16> {
        self.eltek_rps_method_callback.map(|callback| (callback)())
    }

    fn eltek_rps_q_ref(&self) -> Option<u16> {
        self.eltek_rps_q_ref_callback.map(|callback| (callback)())
    }
