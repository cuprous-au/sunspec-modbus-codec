...
use sunspec_modbus_lib_rs::sunspec::models::model_401::*;
...
/// # Safety
/// `adapter` must be null or point to a live `Model401CallbackAdapter`, valid for the
...
unsafe fn model_401_c_visit_read(
    ...
    let adapter = unsafe { (adapter as *const Model401CallbackAdapter).as_ref() };
...
pub extern "C" fn sunspec_model_401_callback(
    adapter: *mut Model401CallbackAdapter,
) -> SunspecAdapter {
    SunspecAdapter {
        model_spec: &SUNSPEC_MODEL_401,
