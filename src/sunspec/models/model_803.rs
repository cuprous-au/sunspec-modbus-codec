...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::StringCount => {
            serialisation::write_u16(model.string_count(), buffer);
        },
...
impl ModelAdapter for Model803CallbackAdapter {
    ...
    /// String containing the module with maximum temperature.
    fn max_module_temperature_string(&self) -> Option<u16> {
        self.max_module_temperature_string_callback.map(|callback| {
    ...
    /// Module with maximum temperature.
    fn max_module_temperature_module(&self) -> Option<u16> {
        self.max_module_temperature_module_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// String containing the module with minimum temperature.
    fn min_module_temperature_string(&self) -> Option<u16> {
        self.min_module_temperature_string_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Module with minimum temperature.
    fn min_module_temperature_module(&self) -> Option<u16> {
        self.min_module_temperature_module_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Calculation based on measurements.
    fn average_module_temperature(&self) -> Option<i16> {
        self.average_module_temperature_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measurement.
    fn max_string_voltage(&self) -> Option<u16> {
        self.max_string_voltage_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// String with maximum voltage.
    fn max_string_voltage_string(&self) -> Option<u16> {
        self.max_string_voltage_string_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measurement.
    fn min_string_voltage(&self) -> Option<u16> {
        self.min_string_voltage_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// String with minimum voltage.
    fn min_string_voltage_string(&self) -> Option<u16> {
        self.min_string_voltage_string_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Calculation based on measurements.
    fn average_string_voltage(&self) -> Option<u16> {
        self.average_string_voltage_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measurement.
    fn max_string_current(&self) -> Option<i16> {
        self.max_string_current_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// String with the maximum current.
    fn max_string_current_string(&self) -> Option<u16> {
        self.max_string_current_string_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Measurement.
    fn min_string_current(&self) -> Option<i16> {
        self.min_string_current_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// String with the minimum current.
    fn min_string_current_string(&self) -> Option<u16> {
        self.min_string_current_string_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Calculation based on measurements.
    fn average_string_current(&self) -> Option<i16> {
        self.average_string_current_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total number of cells that are currently being balanced.
    fn battery_cell_balancing_count(&self) -> Option<u16> {
        self.battery_cell_balancing_count_callback.map(|callback| {
        (callback)(self.context)
        })
    }
...
impl ModelAdapter for Model803StatefulAdapter {
    ...
    fn max_module_temperature_string(&self) -> Option<u16> {
        Some(
        self.max_module_temperature_string
        )
    }
    ...
    fn min_module_temperature_string(&self) -> Option<u16> {
        Some(
        self.min_module_temperature_string
        )
    }
    ...
    fn max_string_voltage_string(&self) -> Option<u16> {
        Some(
        self.max_string_voltage_string
        )
    }
    ...
    fn min_string_voltage_string(&self) -> Option<u16> {
        Some(
        self.min_string_voltage_string
        )
    }
    ...
    fn max_string_current_string(&self) -> Option<u16> {
        Some(
        self.max_string_current_string
        )
    }
    ...
    fn min_string_current_string(&self) -> Option<u16> {
        Some(
        self.min_string_current_string
        )
    }
    ...
    fn battery_cell_balancing_count(&self) -> Option<u16> {
        Some(
        self.battery_cell_balancing_count
        )
    }
