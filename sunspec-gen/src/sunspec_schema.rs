...
#[doc = "JSON Schema for SunSpec information model definition"]
#[doc = r""]
#[doc = r" <details><summary>JSON schema</summary>"]
#[doc = r""]
#[doc = r" ```json"]
#[doc = "{"]
#[doc = "  \"title\": \"SunspecModel\","]
#[doc = "  \"description\": \"JSON Schema for SunSpec information model definition\","]
#[doc = "  \"type\": \"object\","]
#[doc = "  \"required\": ["]
#[doc = "    \"group\","]
#[doc = "    \"id\""]
...
impl SunspecModel {
    pub fn builder() -> builder::SunspecModel {
        Default::default()
    }
}
#[doc = "`Symbol`"]
...
pub mod builder {
    ...
    pub struct SunspecModel {
        ...
        detail: ::std::result::Result<
            ...
            ::std::string::String,
        >,
        group: ::std::result::Result<super::Group, ::std::string::String>,
    ...
    impl ::std::default::Default for SunspecModel {
        fn default() -> Self {
            Self {
                comments: Ok(Default::default()),
                desc: Ok(Default::default()),
    ...
    impl SunspecModel {
        ...
        where
            T: ::std::convert::TryInto<super::Group>,
            T::Error: ::std::fmt::Display,
        {
            self.group = value
                .try_into()
    ...
    impl ::std::convert::TryFrom<SunspecModel> for super::SunspecModel {
        type Error = super::error::ConversionError;
        fn try_from(
            value: SunspecModel,
    ...
    impl ::std::convert::From<super::SunspecModel> for SunspecModel {
        fn from(value: super::SunspecModel) -> Self {
            Self {
                comments: Ok(value.comments),
                desc: Ok(value.desc),
                detail: Ok(value.detail),
