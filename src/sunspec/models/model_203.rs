...
pub static POINTS: [ReadablePoint; 74] = [
    ...
    ReadablePoint {
        reference: PointReference::Model203 {
...
pub struct Model203CallbackAdapter {
    ...
    voltage_ln_callback: extern "C" fn() -> i16,
    phase_voltage_an_callback: extern "C" fn() -> i16,
    phase_voltage_bn_callback: extern "C" fn() -> i16,
    phase_voltage_cn_callback: extern "C" fn() -> i16,
