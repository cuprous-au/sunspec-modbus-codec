...
pub struct Model805CallbackAdapter {
    ...
    module_index_callback: extern "C" fn() -> u16,
    module_cell_count_callback: extern "C" fn() -> u16,
    module_so_c_callback: Option<extern "C" fn() -> u16>,
    depth_of_discharge_callback: Option<extern "C" fn() -> u16>,
    module_so_h_callback: Option<extern "C" fn() -> u16>,
    cycle_count_callback: Option<extern "C" fn() -> u32>,
    module_voltage_callback: extern "C" fn() -> u16,
    max_cell_voltage_callback: extern "C" fn() -> u16,
    max_cell_voltage_cell_callback: Option<extern "C" fn() -> u16>,
    min_cell_voltage_callback: extern "C" fn() -> u16,
    min_cell_voltage_cell_callback: Option<extern "C" fn() -> u16>,
    average_cell_voltage_callback: extern "C" fn() -> u16,
    max_cell_temperature_callback: extern "C" fn() -> i16,
    max_cell_temperature_cell_callback: Option<extern "C" fn() -> u16>,
    min_cell_temperature_callback: extern "C" fn() -> i16,
    min_cell_temperature_cell_callback: Option<extern "C" fn() -> u16>,
    average_cell_temperature_callback: extern "C" fn() -> i16,
    balanced_cell_count_callback: Option<extern "C" fn() -> u16>,
    serial_number_callback: Option<extern "C" fn() -> *const c_char>,
    so_c_sf_callback: Option<extern "C" fn() -> u16>,
...
impl ModelAdapter for Model805CallbackAdapter {
    ...
    /// Count of all cells in the module.
    fn module_cell_count(&self) -> u16 {
        (self.module_cell_count_callback)()
    }
    ...
    /// Module state of charge, expressed as a percentage.
    fn module_so_c(&self) -> Option<u16> {
        self.module_so_c_callback.map(|callback| (callback)())
    }
    ...
    /// Module state of health, expressed as a percentage.
    fn module_so_h(&self) -> Option<u16> {
        self.module_so_h_callback.map(|callback| (callback)())
    }
    ...
    /// Measurement.
    fn max_cell_temperature(&self) -> i16 {
        (self.max_cell_temperature_callback)()
    }
    ...
    /// Measurement.
    fn min_cell_temperature(&self) -> i16 {
        (self.min_cell_temperature_callback)()
    }
    ...
    /// Calculation based on measurements.
    fn average_cell_temperature(&self) -> i16 {
        (self.average_cell_temperature_callback)()
    }
    ...
    /// Scale factor for module state of charge.
    fn so_c_sf(&self) -> Option<u16> {
        self.so_c_sf_callback.map(|callback| (callback)())
    }
