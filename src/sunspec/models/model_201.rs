...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        ...
        Point::AmpsPhaseB => if let Some(value) = model.amps_phase_b() { serialisation::write_i16(value, buffer); },
        Point::AmpsPhaseC => if let Some(value) = model.amps_phase_c() { serialisation::write_i16(value, buffer); },
        Point::ASf => serialisation::write_u16(model.a_sf(), buffer),
        Point::VoltageLn => if let Some(value) = model.voltage_ln() { serialisation::write_i16(value, buffer); },
        Point::PhaseVoltageAn => if let Some(value) = model.phase_voltage_an() { serialisation::write_i16(value, buffer); },
        Point::PhaseVoltageBn => if let Some(value) = model.phase_voltage_bn() { serialisation::write_i16(value, buffer); },
        Point::PhaseVoltageCn => if let Some(value) = model.phase_voltage_cn() { serialisation::write_i16(value, buffer); },
        Point::VoltageLl => if let Some(value) = model.voltage_ll() { serialisation::write_i16(value, buffer); },
        Point::PhaseVoltageAb => if let Some(value) = model.phase_voltage_ab() { serialisation::write_i16(value, buffer); },
