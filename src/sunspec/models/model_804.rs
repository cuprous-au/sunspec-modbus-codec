...
pub static POINTS: [ReadablePoint; 41] = [
    ...
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringIndex },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::ModuleCount },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringStatus },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::ConnectionFailureReason },
        size: 1,
        data_type: PointType::Enum16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringCellBalancingCount },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringStateOfCharge },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringDepthOfDischarge },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringCycleCount },
        size: 2,
        data_type: PointType::Uint32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringStateOfHealth },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringCurrent },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringVoltage },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::MaxCellVoltage },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::MaxCellVoltageModule },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::MinCellVoltage },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::MinCellVoltageModule },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::AverageCellVoltage },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::MaxModuleTemperature },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::MaxModuleTemperatureModule },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::MinModuleTemperature },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::MinModuleTemperatureModule },
        size: 1,
        data_type: PointType::Uint16,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::AverageModuleTemperature },
        size: 1,
        data_type: PointType::Int16,
        writeable: false,
    },
    ...
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::ContactorStatus },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringEvent1 },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::StringEvent2 },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::VendorEventBitfield1 },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::VendorEventBitfield2 },
        size: 2,
        data_type: PointType::Bitfield32,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::EnableDisableString },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::ConnectDisconnectString },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::SoCSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::SoHSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::DoDSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ...
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::CellVSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
    ReadablePoint {
        reference: PointReference::Model804 { point: Point::ModTmpSf },
        size: 1,
        data_type: PointType::Sunssf,
        writeable: false,
    },
...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        ...
        Point::StringStatus => serialisation::write_u32(model.string_status(), buffer, offset, limit),
        Point::ConnectionFailureReason => if let Some(value) = model.connection_failure_reason() { serialisation::write_u16(value as u16, buffer); },
        Point::StringCellBalancingCount => if let Some(value) = model.string_cell_balancing_count() { serialisation::write_u16(value, buffer); },
        Point::StringStateOfCharge => serialisation::write_u16(model.string_state_of_charge(), buffer),
        Point::StringDepthOfDischarge => if let Some(value) = model.string_depth_of_discharge() { serialisation::write_u16(value, buffer); },
        Point::StringCycleCount => if let Some(value) = model.string_cycle_count() { serialisation::write_u32(value, buffer, offset, limit); },
        Point::StringStateOfHealth => if let Some(value) = model.string_state_of_health() { serialisation::write_u16(value, buffer); },
        Point::StringCurrent => serialisation::write_i16(model.string_current(), buffer),
        Point::StringVoltage => if let Some(value) = model.string_voltage() { serialisation::write_u16(value, buffer); },
        ...
        Point::MaxModuleTemperature => serialisation::write_i16(model.max_module_temperature(), buffer),
        Point::MaxModuleTemperatureModule => serialisation::write_u16(model.max_module_temperature_module(), buffer),
        Point::MinModuleTemperature => serialisation::write_i16(model.min_module_temperature(), buffer),
        Point::MinModuleTemperatureModule => serialisation::write_u16(model.min_module_temperature_module(), buffer),
        Point::AverageModuleTemperature => serialisation::write_i16(model.average_module_temperature(), buffer),
        Point::ContactorStatus => if let Some(value) = model.contactor_status() { serialisation::write_u32(value, buffer, offset, limit); },
        Point::StringEvent1 => serialisation::write_u32(model.string_event_1(), buffer, offset, limit),
        Point::StringEvent2 => if let Some(value) = model.string_event_2() { serialisation::write_u32(value, buffer, offset, limit); },
        ...
        Point::EnableDisableString => if let Some(value) = model.enable_disable_string() { serialisation::write_u16(value as u16, buffer); },
        Point::ConnectDisconnectString => if let Some(value) = model.connect_disconnect_string() { serialisation::write_u16(value as u16, buffer); },
        ...
        Point::VSf => if let Some(value) = model.v_sf() { serialisation::write_u16(value, buffer); },
