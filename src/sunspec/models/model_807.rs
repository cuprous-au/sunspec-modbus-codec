...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        ...
        Point::MaxModuleVoltage => {
            serialisation::write_u16(model.max_module_voltage(), buffer);
        },
        ...
        Point::MinModuleVoltage => {
            serialisation::write_u16(model.min_module_voltage(), buffer);
        },
        ...
        Point::MaxTemperature => {
            serialisation::write_i16(model.max_temperature(), buffer);
        },
        ...
        Point::MinTemperature => {
            serialisation::write_i16(model.min_temperature(), buffer);
        },
        ...
        Point::AverageTemperature => {
            serialisation::write_i16(model.average_temperature(), buffer);
        },
        Point::StringEvent1 => {
        ...
        Point::ModVSf => {
            serialisation::write_u16(model.mod_v_sf(), buffer);
        },
        Point::CellVSf => {
        ...
        Point::OcvSf => {
            serialisation::write_u16(model.ocv_sf(), buffer);
        },
    }
}
