...
pub static POINTS: [ReadablePoint; 45] = [
    ...
    ReadablePoint {
        reference: PointReference::Model704 {
            point: Point::SetActivePowerEnable,
        },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    ...
    ReadablePoint {
        reference: PointReference::Model704 {
            point: Point::SetActivePowerMode,
        },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    ...
    ReadablePoint {
        reference: PointReference::Model704 {
            point: Point::SetReactivePowerEnable,
        },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
    ...
    ReadablePoint {
        reference: PointReference::Model704 {
            point: Point::SetReactivePowerMode,
        },
        size: 1,
        data_type: PointType::Enum16,
        writeable: true,
...
pub fn write_point(
    ...
    match point {
        ...
        Point::SetActivePowerEnable => {
            if let Some(value) = model.set_active_power_enable() {
                serialisation::write_u16(value as u16, buffer);
            }
        }
        Point::SetActivePowerMode => {
            if let Some(value) = model.set_active_power_mode() {
                serialisation::write_u16(value as u16, buffer);
            }
        }
        ...
        Point::SetReactivePowerEnable => {
            if let Some(value) = model.set_reactive_power_enable() {
                serialisation::write_u16(value as u16, buffer);
            }
        }
        Point::SetReactivePowerMode => {
            if let Some(value) = model.set_reactive_power_mode() {
                serialisation::write_u16(value as u16, buffer);
            }
        }
...
pub struct Model704CallbackAdapter {
    power_factor_enable_w_inj_enable_callback: Option<extern "C" fn() -> PfwInjEna>,
    set_power_factor_enable_w_inj_enable_callback: Option<extern "C" fn(PfwInjEna)>,
    power_factor_reversion_enable_w_inj_callback: Option<extern "C" fn() -> PfwInjEnaRvrt>,
    set_power_factor_reversion_enable_w_inj_callback: Option<extern "C" fn(PfwInjEnaRvrt)>,
    pf_reversion_time_w_inj_callback: Option<extern "C" fn() -> u32>,
    set_pf_reversion_time_w_inj_callback: Option<extern "C" fn(u32)>,
    pf_reversion_time_rem_w_inj_callback: Option<extern "C" fn() -> u32>,
    power_factor_enable_w_abs_enable_callback: Option<extern "C" fn() -> PfwAbsEna>,
    set_power_factor_enable_w_abs_enable_callback: Option<extern "C" fn(PfwAbsEna)>,
    power_factor_reversion_enable_w_abs_callback: Option<extern "C" fn() -> PfwAbsEnaRvrt>,
    set_power_factor_reversion_enable_w_abs_callback: Option<extern "C" fn(PfwAbsEnaRvrt)>,
    pf_reversion_time_w_abs_callback: Option<extern "C" fn() -> u32>,
    set_pf_reversion_time_w_abs_callback: Option<extern "C" fn(u32)>,
    pf_reversion_time_rem_w_abs_callback: Option<extern "C" fn() -> u32>,
    limit_max_power_pct_enable_callback: Option<extern "C" fn() -> WMaxLimPctEna>,
    set_limit_max_power_pct_enable_callback: Option<extern "C" fn(WMaxLimPctEna)>,
    limit_max_power_pct_setpoint_callback: Option<extern "C" fn() -> u16>,
    set_limit_max_power_pct_setpoint_callback: Option<extern "C" fn(u16)>,
    reversion_limit_max_power_pct_callback: Option<extern "C" fn() -> u16>,
    set_reversion_limit_max_power_pct_callback: Option<extern "C" fn(u16)>,
    reversion_limit_max_power_pct_enable_callback: Option<extern "C" fn() -> WMaxLimPctEnaRvrt>,
    set_reversion_limit_max_power_pct_enable_callback: Option<extern "C" fn(WMaxLimPctEnaRvrt)>,
    limit_max_power_pct_reversion_time_callback: Option<extern "C" fn() -> u32>,
    set_limit_max_power_pct_reversion_time_callback: Option<extern "C" fn(u32)>,
    limit_max_power_pct_rev_time_rem_callback: Option<extern "C" fn() -> u32>,
    set_active_power_enable_callback: Option<extern "C" fn() -> WSetEna>,
    set_set_active_power_enable_callback: Option<extern "C" fn(WSetEna)>,
    set_active_power_mode_callback: Option<extern "C" fn() -> WSetMod>,
    set_set_active_power_mode_callback: Option<extern "C" fn(WSetMod)>,
    active_power_setpoint_w_callback: Option<extern "C" fn() -> i32>,
    set_active_power_setpoint_w_callback: Option<extern "C" fn(i32)>,
    reversion_active_power_w_callback: Option<extern "C" fn() -> i32>,
    set_reversion_active_power_w_callback: Option<extern "C" fn(i32)>,
    active_power_setpoint_pct_callback: Option<extern "C" fn() -> i16>,
    set_active_power_setpoint_pct_callback: Option<extern "C" fn(i16)>,
    reversion_active_power_pct_callback: Option<extern "C" fn() -> i16>,
    set_reversion_active_power_pct_callback: Option<extern "C" fn(i16)>,
    reversion_active_power_enable_callback: Option<extern "C" fn() -> WSetEnaRvrt>,
    set_reversion_active_power_enable_callback: Option<extern "C" fn(WSetEnaRvrt)>,
    active_power_reversion_time_callback: Option<extern "C" fn() -> u32>,
    set_active_power_reversion_time_callback: Option<extern "C" fn(u32)>,
    active_power_rev_time_rem_callback: Option<extern "C" fn() -> u32>,
    set_reactive_power_enable_callback: Option<extern "C" fn() -> VarSetEna>,
    set_set_reactive_power_enable_callback: Option<extern "C" fn(VarSetEna)>,
    set_reactive_power_mode_callback: Option<extern "C" fn() -> VarSetMod>,
    set_set_reactive_power_mode_callback: Option<extern "C" fn(VarSetMod)>,
    reactive_power_priority_callback: Option<extern "C" fn() -> VarSetPri>,
    set_reactive_power_priority_callback: Option<extern "C" fn(VarSetPri)>,
    reactive_power_setpoint_vars_callback: Option<extern "C" fn() -> i32>,
    set_reactive_power_setpoint_vars_callback: Option<extern "C" fn(i32)>,
    reversion_reactive_power_vars_callback: Option<extern "C" fn() -> i32>,
    set_reversion_reactive_power_vars_callback: Option<extern "C" fn(i32)>,
    reactive_power_setpoint_pct_callback: Option<extern "C" fn() -> i16>,
    set_reactive_power_setpoint_pct_callback: Option<extern "C" fn(i16)>,
    reversion_reactive_power_pct_callback: Option<extern "C" fn() -> i16>,
    set_reversion_reactive_power_pct_callback: Option<extern "C" fn(i16)>,
    reversion_reactive_power_enable_callback: Option<extern "C" fn() -> VarSetEnaRvrt>,
    set_reversion_reactive_power_enable_callback: Option<extern "C" fn(VarSetEnaRvrt)>,
    reactive_power_reversion_time_callback: Option<extern "C" fn() -> u32>,
    set_reactive_power_reversion_time_callback: Option<extern "C" fn(u32)>,
    reactive_power_rev_time_rem_callback: Option<extern "C" fn() -> u32>,
    normal_ramp_rate_callback: Option<extern "C" fn() -> u16>,
    set_normal_ramp_rate_callback: Option<extern "C" fn(u16)>,
    normal_ramp_rate_reference_callback: Option<extern "C" fn() -> WRmpRef>,
    set_normal_ramp_rate_reference_callback: Option<extern "C" fn(WRmpRef)>,
    reactive_power_ramp_rate_callback: Option<extern "C" fn() -> u16>,
    set_reactive_power_ramp_rate_callback: Option<extern "C" fn(u16)>,
    anti_islanding_enable_callback: Option<extern "C" fn() -> AntiIslEna>,
    set_anti_islanding_enable_callback: Option<extern "C" fn(AntiIslEna)>,
    power_factor_scale_factor_callback: Option<extern "C" fn() -> u16>,
    limit_max_power_scale_factor_callback: Option<extern "C" fn() -> u16>,
    active_power_scale_factor_callback: Option<extern "C" fn() -> u16>,
    active_power_pct_scale_factor_callback: Option<extern "C" fn() -> u16>,
    reactive_power_scale_factor_callback: Option<extern "C" fn() -> u16>,
    reactive_power_pct_scale_factor_callback: Option<extern "C" fn() -> u16>,
}
...
impl ModelAdapter for Model704CallbackAdapter {
    ...
    /// Set active power enable.
    fn set_active_power_enable(&self) -> Option<WSetEna> {
        self.set_active_power_enable_callback
            .map(|callback| (callback)())
    }
    ...
    /// Set active power enable.
    fn set_set_active_power_enable(&mut self, value: WSetEna) {
        if let Some(callback) = self.set_set_active_power_enable_callback {
            (callback)(value);
        };
    }
    ...
    /// Set active power mode.
    fn set_active_power_mode(&self) -> Option<WSetMod> {
        self.set_active_power_mode_callback
            .map(|callback| (callback)())
    }
    ...
    /// Set active power mode.
    fn set_set_active_power_mode(&mut self, value: WSetMod) {
        if let Some(callback) = self.set_set_active_power_mode_callback {
            (callback)(value);
        };
    }
    ...
    /// Set reactive power enable.
    fn set_reactive_power_enable(&self) -> Option<VarSetEna> {
        self.set_reactive_power_enable_callback
            .map(|callback| (callback)())
    }
    ...
    /// Set reactive power enable.
    fn set_set_reactive_power_enable(&mut self, value: VarSetEna) {
        if let Some(callback) = self.set_set_reactive_power_enable_callback {
            (callback)(value);
        };
    }
    ...
    /// Set reactive power mode.
    fn set_reactive_power_mode(&self) -> Option<VarSetMod> {
        self.set_reactive_power_mode_callback
            .map(|callback| (callback)())
    }
    ...
    /// Set reactive power mode.
    fn set_set_reactive_power_mode(&mut self, value: VarSetMod) {
        if let Some(callback) = self.set_set_reactive_power_mode_callback {
            (callback)(value);
        };
    }
    ...
    /// Ramp rate for increases in active power during normal generation.
    fn normal_ramp_rate(&self) -> Option<u16> {
        self.normal_ramp_rate_callback.map(|callback| (callback)())
    }
