...
pub fn write_point(model: &dyn ModelAdapter, point: &Point, buffer: &mut [u16], offset: u16, limit: u16) {
    match point {
        Point::AcWiringType => {
            serialisation::write_u16(model.ac_wiring_type() as u16, buffer);
        },
...
impl ModelAdapter for Model701CallbackAdapter {
    ...
    /// Operating state of the DER.
    fn operating_state(&self) -> Option<St> {
        self.operating_state_callback.map(|callback| {
    ...
    /// Inverter state.
    fn inverter_state(&self) -> Option<InvSt> {
        self.inverter_state_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Grid connection state of the DER.
    fn grid_connection_state(&self) -> Option<ConnSt> {
        self.grid_connection_state_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Active alarms for the DER.
    fn alarm_bitfield(&self) -> Option<u32> {
        self.alarm_bitfield_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Current operational characteristics of the DER.
    fn der_operational_characteristics(&self) -> Option<u32> {
        self.der_operational_characteristics_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total active power. Active power is positive for DER generation and negative for absorption.
    fn active_power(&self) -> Option<i16> {
        self.active_power_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total apparent power.
    fn apparent_power(&self) -> Option<i16> {
        self.apparent_power_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total reactive power.
    fn reactive_power(&self) -> Option<i16> {
        self.reactive_power_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Power factor. The sign of power factor should be the sign of active power.
    fn power_factor(&self) -> Option<i16> {
        self.power_factor_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total AC current.
    fn total_ac_current(&self) -> Option<i16> {
        self.total_ac_current_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Line to line AC voltage as an average of active phases.
    fn voltage_ll(&self) -> Option<u16> {
        self.voltage_ll_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Line to neutral AC voltage as an average of active phases.
    fn voltage_ln(&self) -> Option<u16> {
        self.voltage_ln_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// AC frequency.
    fn frequency(&self) -> Option<u32> {
        self.frequency_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total active energy injected (Quadrants 1 & 4).
    fn total_energy_injected(&self) -> Option<u64> {
        self.total_energy_injected_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total active energy absorbed (Quadrants 2 & 3).
    fn total_energy_absorbed(&self) -> Option<u64> {
        self.total_energy_absorbed_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total reactive energy injected (Quadrants 1 & 2).
    fn total_reactive_energy_inj(&self) -> Option<u64> {
        self.total_reactive_energy_inj_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total reactive energy absorbed (Quadrants 3 & 4).
    fn total_reactive_energy_abs(&self) -> Option<u64> {
        self.total_reactive_energy_abs_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Cabinet temperature.
    fn cabinet_temperature(&self) -> Option<i16> {
        self.cabinet_temperature_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Heat sink temperature.
    fn heat_sink_temperature(&self) -> Option<i16> {
        self.heat_sink_temperature_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Transformer temperature.
    fn transformer_temperature(&self) -> Option<i16> {
        self.transformer_temperature_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// IGBT/MOSFET temperature.
    fn igbt_mosfet_temperature(&self) -> Option<i16> {
        self.igbt_mosfet_temperature_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Other temperature.
    fn other_temperature(&self) -> Option<i16> {
        self.other_temperature_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Active power L1.
    fn watts_l1(&self) -> Option<i16> {
        self.watts_l1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Apparent power L1.
    fn va_l1(&self) -> Option<i16> {
        self.va_l1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Reactive power L1.
    fn var_l1(&self) -> Option<i16> {
        self.var_l1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Power factor phase L1.
    fn pf_l1(&self) -> Option<i16> {
        self.pf_l1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Current phase L1.
    fn amps_l1(&self) -> Option<i16> {
        self.amps_l1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Phase voltage L1-L2.
    fn phase_voltage_l1_l2(&self) -> Option<u16> {
        self.phase_voltage_l1_l2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Phase voltage L1-N.
    fn phase_voltage_l1_n(&self) -> Option<u16> {
        self.phase_voltage_l1_n_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total active energy injected L1.
    fn total_watt_hours_inj_l1(&self) -> Option<u64> {
        self.total_watt_hours_inj_l1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total active energy absorbed L1.
    fn total_watt_hours_abs_l1(&self) -> Option<u64> {
        self.total_watt_hours_abs_l1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total reactive energy injected L1.
    fn total_var_hours_inj_l1(&self) -> Option<u64> {
        self.total_var_hours_inj_l1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total reactive energy absorbed L1.
    fn total_var_hours_abs_l1(&self) -> Option<u64> {
        self.total_var_hours_abs_l1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Active power L2.
    fn watts_l2(&self) -> Option<i16> {
        self.watts_l2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Apparent power L2.
    fn va_l2(&self) -> Option<i16> {
        self.va_l2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Reactive power L2.
    fn var_l2(&self) -> Option<i16> {
        self.var_l2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Power factor L2.
    fn pf_l2(&self) -> Option<i16> {
        self.pf_l2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Current L2.
    fn amps_l2(&self) -> Option<i16> {
        self.amps_l2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Phase voltage L2-L3.
    fn phase_voltage_l2_l3(&self) -> Option<u16> {
        self.phase_voltage_l2_l3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Phase voltage L2-N.
    fn phase_voltage_l2_n(&self) -> Option<u16> {
        self.phase_voltage_l2_n_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total active energy injected L2.
    fn total_watt_hours_inj_l2(&self) -> Option<u64> {
        self.total_watt_hours_inj_l2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total active energy absorbed L2.
    fn total_watt_hours_abs_l2(&self) -> Option<u64> {
        self.total_watt_hours_abs_l2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total reactive energy injected L2.
    fn total_var_hours_inj_l2(&self) -> Option<u64> {
        self.total_var_hours_inj_l2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total reactive energy absorbed L2.
    fn total_var_hours_abs_l2(&self) -> Option<u64> {
        self.total_var_hours_abs_l2_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Active power L3.
    fn watts_l3(&self) -> Option<i16> {
        self.watts_l3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Apparent power L3.
    fn va_l3(&self) -> Option<i16> {
        self.va_l3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Reactive power L3.
    fn var_l3(&self) -> Option<i16> {
        self.var_l3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Power factor L3.
    fn pf_l3(&self) -> Option<i16> {
        self.pf_l3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Current L3.
    fn amps_l3(&self) -> Option<i16> {
        self.amps_l3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Phase voltage L3-L1.
    fn phase_voltage_l3_l1(&self) -> Option<u16> {
        self.phase_voltage_l3_l1_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Phase voltage L3-N.
    fn phase_voltage_l3_n(&self) -> Option<u16> {
        self.phase_voltage_l3_n_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total active energy injected L3.
    fn total_watt_hours_inj_l3(&self) -> Option<u64> {
        self.total_watt_hours_inj_l3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total active energy absorbed L3.
    fn total_watt_hours_abs_l3(&self) -> Option<u64> {
        self.total_watt_hours_abs_l3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total reactive energy injected L3.
    fn total_var_hours_inj_l3(&self) -> Option<u64> {
        self.total_var_hours_inj_l3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Total reactive energy absorbed L3.
    fn total_var_hours_abs_l3(&self) -> Option<u64> {
        self.total_var_hours_abs_l3_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Throttling in pct of maximum active power.
    fn throttling_in_pct(&self) -> Option<u16> {
        self.throttling_in_pct_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Active throttling source.
    fn throttle_source_information(&self) -> Option<u32> {
        self.throttle_source_information_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Apparent power scale factor.
    fn apparent_power_scale_factor(&self) -> Option<u16> {
        self.apparent_power_scale_factor_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Active energy scale factor.
    fn active_energy_scale_factor(&self) -> Option<u16> {
        self.active_energy_scale_factor_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Reactive energy scale factor.
    fn reactive_energy_scale_factor(&self) -> Option<u16> {
        self.reactive_energy_scale_factor_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Temperature scale factor.
    fn temperature_scale_factor(&self) -> Option<u16> {
        self.temperature_scale_factor_callback.map(|callback| {
        (callback)(self.context)
        })
    }
    ...
    /// Manufacturer alarm information. Valid if MANUFACTURER_ALRM indication is active.
    fn manufacturer_alarm_info(&self) -> Option<&CStr> {
        self.manufacturer_alarm_info_callback.map(|callback| {
...
impl ModelAdapter for Model701StatefulAdapter {
    ...
    fn der_operational_characteristics(&self) -> Option<u32> {
        Some(
        self.der_operational_characteristics
        )
    }
    ...
    fn total_reactive_energy_inj(&self) -> Option<u64> {
        Some(
        self.total_reactive_energy_inj
        )
    }
    ...
    fn total_reactive_energy_abs(&self) -> Option<u64> {
        Some(
        self.total_reactive_energy_abs
        )
    }
    ...
    fn throttle_source_information(&self) -> Option<u32> {
        Some(
        self.throttle_source_information
        )
    }
    ...
    fn apparent_power_scale_factor(&self) -> Option<u16> {
        Some(
        self.apparent_power_scale_factor
        )
    }
    ...
    fn active_energy_scale_factor(&self) -> Option<u16> {
        Some(
        self.active_energy_scale_factor
        )
    }
    ...
    fn reactive_energy_scale_factor(&self) -> Option<u16> {
        Some(
        self.reactive_energy_scale_factor
        )
    }
    ...
    fn manufacturer_alarm_info(&self) -> Option<&CStr> {
        Some(
        unsafe { CStr::from_ptr(self.manufacturer_alarm_info.as_ptr()) }
        )
    }
}